...
\item ogni volta che si cita un documento, bisogna indicare con la lettera maiuscola le iniziali dei nomi di cui è composto, precisandone la versione solo se si fa riferimento ad una \textbf{versione specifica} del documento in questione (e.i. \textit{Norme\_di\_Progetto\_v1.0.0});
