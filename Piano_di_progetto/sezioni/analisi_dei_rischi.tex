...
\begin{longtable}{C{3cm}|C{4.5cm}|C{4.5cm}|C{3cm}}
...
\multicolumn{3}{p{0.7755\textwidth}}{Gli stakeholders dovranno decidere di utilizzare gli strumenti di comunicazione disponibili a tutti che limitino i disagi scaturiti dalle suddette restrizioni.} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{Il \textit{responsabile} una volta messo al corrente delle  conoscenze dei componenti, affiderà loro i ruoli che più li competono.} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{È consigliato comunticare tempestivamente al committente la variazione dei costi.} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{È consigliato comunticare tempestivamente al \textit{responsabile} i propri impegni accademici.} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{È consigliato comunticare tempestivamente al \textit{responsabile} i propri impegni.} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{È consigliato riassegnare risorse laddove ce ne sia bisogno, e quindi risolvere il motivo del ritardo.} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{Il gruppo ha adottato diversi mezzi di comunicazione} \\
...
Piano di contingenza &
\multicolumn{3}{p{0.7755\textwidth}}{Il gruppo ha adottato diversi mezzi di comunicazione per rimanere in contatto con il proponente} \\
