...
% - Casi d'uso: Principali - %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\subsection{UC1 - Creazione file JSON dai Dati di Addestramento}
		\begin{itemize}
			...
			\item\textbf{Inclusione}: \hyperref[par:UC17]{UC17} include \hyperref[par:UC1.5]{UC1.5}: viene visualizzato a schermo un messaggio di notifica di avvenuto successo della procedura.
		\end{itemize}
	...
	\subsubsection{UC1.5 - Salvataggio File JSON}
		\begin{itemize}
			...
			\item\textbf{Inclusione}: \hyperref[par:UC17]{UC17} : viene visualizzato a schermo un messaggio di notifica di avvenuto successo della procedura di salvataggio del file JSON.			
		\end{itemize}
	...
	\subsection{UC2 - Caricamento del file JSON nel plug-in}
		\begin{itemize}
			...
			\item\textbf{Estensione}:
				...
				\end{enumerate}	
			\item\textbf{Inclusione}:\hyperref[par:UC18]{UC18} include \hyperref[par:UC2.3]{UC2.3}: viene visualizzato a schermo un messaggio di notifica di avvenuto successo della procedura di caricamenteo JSON.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item\textbf{Inclusione}: \hyperref[par:UC18]{UC18}: viene visualizzato a schermo un messaggio di notifica di avvenuto successo della procedura di caricamenteo JSON.	
		\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{UC3 - Collegamento del Predittore al Flusso Dati}
		\begin{itemize}
			...
			\item\textbf{Inclusione}:
				\begin{enumerate}
					\item\hyperref[par:UC19]{UC19} include \hyperref[par:UC3.6]{UC3.6}: viene visualizzata una notifica avvenuto collegamento al nodo del flusso dati se la procedura è andata a buon fine.
					\item\hyperref[par:UC20]{UC20} include \hyperref[par:UC3.6]{UC3.6}:  l'utente visualizza una lista dei collegamenti con le rispettive impostazioni di collegamento selezionate;
				\end{enumerate}
		\end{itemize}
	...
	\subsubsection{UC3.6 - Conferma Collegamento}
		\begin{itemize}
			...
			\item\textbf{Estensioni}:\item\hyperref[par:UC13]{UC13} estende \hyperref[par:UC3.6]{UC3.6}: viene visualizzato un messaggio d’errore nel caso il collegamento non sia stato possibile;
			\item\textbf{Inclusione}: 
				\begin{enumerate}
					\item\hyperref[par:UC19]{UC19}: viene visualizzata una notifica avvenuto collegamento al nodo del flusso dati se la procedura è andata a buon fine;
					\item\hyperref[par:UC20]{UC20}: l'utente visualizza una lista dei collegamenti con le rispettive impostazioni di collegamento selezionate.
				\end{enumerate}
		\end{itemize}
...
%Possibilità di inserire Scollegamento e modifica dentro a unico UC - "Operazioni sui collegamenti"
	...
	\subsection{UC4 - Scollegamento Predittore}
		\begin{itemize}
			...
			\item\textbf{Precondizioni}: 
				\begin{enumerate}
					\item l'utente si trova sul pannello dedicato alla lista dei collegamenti tra predittore e flusso dati (\hyperref[par:UC]{UC});
			...
			\item\textbf{Inclusioni}: \hyperref[par:UC21]{UC21}: viene visualizzato un messaggio di alert "Procedere con lo  Scollegamento?" che interroga l'utente sull'effettiva conferma della procedura attuata. 
		\end{itemize}	
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\item\textbf{Postcondizioni}: 
			...
			\item\textbf{Inclusioni}: 
				\begin{enumerate} 
					\item (\hyperref[par:UC22]{UC22}) include (\hyperref[par:UC6.2]{UC6.2}): viene visualizzato un messaggio di notifica di "Monitoraggio Avviato con Sucesso";
					...
					\item (\hyperref[par:UC24]{UC24}) include (\hyperref[par:UC6.3]{UC6.3}): viene visualizzata un messaggio di notifica di "Invio Dati Avvenuto con Sucesso".
				\end{enumerate}				
		\end{itemize}
	...
	\subsubsection{UC6.2 - Avvio Monitoraggio}
		\begin{itemize}
			...
			\item\textbf{Inclusioni}: 
				\begin{enumerate} 
					\item (\hyperref[par:UC22]{UC22}): viene visualizzata un messaggio di notifica di "Monitoraggio Avviato con Sucesso".
		...
		\begin{itemize}
			...
			\item\textbf{Precondizioni}: 
				\begin{enumerate}
					...
					\item l’utente ha avviato il monitoraggio (\hyperref[par:UC6.2]{UC6.2}) e dispone delle previsioni sul flusso di dati in quanto il calcolo di previsione è stato completato correttamente  (\hyperref[par:UC]{UC});
				\end{enumerate}
			...
			\item\textbf{Inclusioni} (\hyperref[par:UC24]{UC24} : viene visualizzato un messaggio di notifica di "Invio Previsione Avvenuto con Sucesso".
		\end{itemize}	
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{UC7 - Interruzione Monitoraggio}
		\begin{itemize}
			...
			\item\textbf{Inclusioni }: \hyperref[par:UC23]{UC23}: viene visualizzata una notifica di "Monitoraggio interrotto".		
		\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

	\label{par:UC8}
	\subsection{UC8 - Visualizzazione Previsioni Associate ai Predittori Monitorati}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
			...
			\item\textbf{Inclusioni}: \hyperref[par:UC25]{UC25}: ogni volta che una soglia critica viene attivata dai dati di previsioni viene visualizzato un messaggio di alert. 
		\end{itemize}
...
% - Casi d'uso: Inclusioni - %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC17}
	\subsection{UC17 - Visualizzazione Messaggio di Notifica Avvenuto Successo Salvataggio file JSON}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC18}
	\subsection{UC18 - Visualizzazione Messaggio di Notifica Avvenuto Successo Caricamento JSON}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC19}
	\subsection{UC19 - Visualizzazione Messaggio di Notifica Collegamento Avvenuto con Successo}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC20}
	\subsection{UC20 - Visualizzazione Pannello Lista Collegamenti}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC21}
	\subsection{UC21 - Visualizzazione Messaggio di Alert Procedere con lo Scollegamento}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC22}
	\subsection{UC22 - Visualizzazione Messaggio di Notifica Monitoraggio Avviato con Successo}	
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC23}
	\subsection{UC23 - Visualizzazione Messaggio di Notifica Monitoraggio Interrotto}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\label{par:UC24}
	\subsection{UC24 - Visualizzazione Messaggio di Notifica Salvataggio Previsione Avvenuta con Successo}	\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
...
\label{par:UC25}
	\subsection{UC25 - Visualizzazione Messaggio di Alert Soglia Critica Raggiunta}
		\begin{itemize}
			\item\textbf{Attore Primario}: Utente;
