...
\textbf{validazione} \\
Attività che intende accertare che il prodotto finale corrisponda alle attese. Risponde
...
\textbf{Verbale di Riunione} \\
Documento stilato dal segretario di riunione, è redatto ogni qualvolta il team si
riunisce. Contiene gli argomenti discussi, i compiti assegnati ed eventualmente la
rotazione periodica dei ruoli.

\textbf{Verifica} \\
Attività facente parte dei processi di supporto, nella quale i verificatori controllano
...
Metodo di lavoro che standardizza le attività di progetto in modo da renderle sistematiche, disciplinate e quantificabili.
\newpage
\section{X}
