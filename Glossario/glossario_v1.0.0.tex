...
\textbf{Snake case} \\
Lo snake case, o snake\_case, è la pratica di scrivere parole composte separandole con il carattere underscore ("\_"). Solitamente, le prime lettere delle singole parole sono scritte in minuscolo.
